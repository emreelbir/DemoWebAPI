...
namespace WebApi.Controllers
{
    ...
    public class PeopleController : ApiController
    {
        ...
        {
            people.Add(new Person { FirstName = "Emre", LastName = "Elbir", Id = 1 });
            people.Add(new Person { FirstName = "Salih", LastName = "Yilmaz", Id = 2 });
            people.Add(new Person { FirstName = "Sude", LastName = "Eren", Id =  3});
        }
        /// <summary>
        /// Gets a list of the first names of all users.
        /// </summary>
        /// <param name="userId">The unique identier for this person</param>
